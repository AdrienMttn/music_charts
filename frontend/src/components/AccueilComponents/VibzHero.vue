...
<template>
  <div
    class="flex flex-col-reverse lg:flex-row items-center justify-between pt-9 md:pt-12 lg:pt-38 mx-[5%] lg:ml-[10%] lg:mr-[8%] gap-10"
  >
    <div class="flex-[1.2] flex flex-col gap-[30px] w-full">
      <section>
        <h1
          class="text-white font-medium leading-[1.2] text-left lg:text-left max-lg:text-center text-[clamp(1.2rem,3.5vw,2.5rem)]"
        >
          Une sensation vibrante du meilleur titre de la semaine. <br />
          Laissez-vous emporter par cette mélodie qui définit la saison !
        </h1>
      </section>
