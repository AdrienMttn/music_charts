...
<template>
  <div class="relative w-full max-w-[300px]">
    ...
    <div
      v-if="isOpen"
      class="absolute z-50 w-full mt-2 bg-white/10 border border-white/20 rounded-[24px] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-150 backdrop-blur-md"
    >
      <div
        class="max-h-60 md:overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb]:rounded-full"
      >
        <div
